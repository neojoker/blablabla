...
//write_header(NECESITA PARAMETRO);**************
//write_body(NECESITA PARAMETRO);******************
write_notificacion();
secuencia();
     	...
     	<fieldset>
          <legend>Notification Poll</legend>
        	<ol>
                ...
                <input type="text" autofocus="" required="" placeholder="Validez" name="Validez" id="validez" maxlength="2" width="20"> 
